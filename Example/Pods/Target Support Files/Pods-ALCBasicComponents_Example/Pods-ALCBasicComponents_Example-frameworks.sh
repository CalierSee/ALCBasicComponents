...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ALCBasicComponents/ALCBasicComponents.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XYColorOC/XYColorOC.framework"
